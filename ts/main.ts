...
const themeSwitch: HTMLElement | null = document.querySelector(".mode");
...
themeSwitch?.addEventListener("click", () => {
  ...
  if (root.classList.contains("light-theme")) {
    ...
    themeSwitch.innerHTML = `<svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
...
const sendMessage = () => {
  const contactForm = document.querySelector("#contact") as HTMLElement;
  ...
  //   console.log(JSON.stringify({ fullName, email, subject, message }, null, 2));
